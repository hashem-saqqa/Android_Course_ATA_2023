...
public class StudentsAdapter extends RecyclerView.Adapter<StudentsAdapter.StudentViewHolder> {
    ...
    public StudentsAdapter(ArrayList<Student> students, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull StudentViewHolder holder, int position) {
        ...
        holder.studentId.setText(String.valueOf(s.getStudentId()));
        holder.studentName.setText(s.getStudentName());
        holder.studentGPA.setText(String.valueOf(s.getStudentGPA()));
